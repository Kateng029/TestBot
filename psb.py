...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EnKmnUWiS9cG2g1owXA0.vGpdYiVRGTlFsIwEDLJ2qa.s1TkiN70Amaf/pHk3VWZ5N1jk/VRWoL+zI5tvHnqLwA=')
cl.loginResult()
...
Bots=[mid]
Creator="u9ac691269fe8b1b740a058411df95bd8"
admin=["u9ac691269fe8b1b740a058411df95bd8"]
...
wait = {
    ...
    "Timeline":True,
    'autoAdd':True,
    "comment":"Bot Auto Like ©By : Noname",
    "commentOn":True,
    "commentBlack":{},
    "likeOn":False,
    "blacklist":{},
