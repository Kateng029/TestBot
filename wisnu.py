...
Creator="u2491f1ee0eca203535aa97d27e1f01b0"
admin="u2491f1ee0eca203535aa97d27e1f01b0"
...
wait = {
    ...
    "comment4":"Nice Kak (^_^)",
    "comment5":"Bot Auto Like ©By : Noname",    
    "commentOn":True,
    "commentBlack":{},
    "likeOn":False,
    "blacklist":{},
...
#--------------------------------------------------------
            ...
            elif msg.text.lower() in ["auto like"]:
                if wait["likeOn"] == True:
                    if wait["lang"] == "JP":
...
#--------------------------------------------------------
                ...
                midd = msg.text.replace("Invite creator ","u14f64e139a3817afaabe27d237afb36b")
                cl.findAndAddContactsByMid(midd)
                cl.inviteIntoGroup(msg.to,[midd])
#--------------------------------------------------------
